...
FITO_PDF_DIR         = os.path.join(os.path.dirname(__file__), "pdfs")
...
def _tiene_pdf(id_producto: int) -> bool:
    return os.path.exists(os.path.join(FITO_PDF_DIR, f"{id_producto}.pdf"))
...
async def fito_pdf(id_producto: int):
    ...
    pdf_path = os.path.join(FITO_PDF_DIR, f"{id_producto}.pdf")
